...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('empresas.store') }}" id="create-form">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input id="razao_social" class="form-control @error('razao_social') is-invalid @enderror" type="text" name="razao_social" value="{{ old('razao_social') }}" required>
                        @error('razao_social')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input id="cnpj" class="form-control @error('cnpj') is-invalid @enderror" type="text" name="cnpj" value="{{ old('cnpj') }}" required placeholder="00.000.000/0000-00">
                        @error('cnpj')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input id="responsavel" class="form-control @error('responsavel') is-invalid @enderror" type="text" name="responsavel" value="{{ old('responsavel') }}">
                        @error('responsavel')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>

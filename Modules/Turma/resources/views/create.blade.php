                    ...
                    <form method="POST" action="{{ route('turmas.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-2">
                                ...
                                <x-text-input id="nome" class="block mt-1 w-full" type="text" name="nome" :value="old('nome')" required autofocus placeholder="Ex: 3º Ano A" />
                            ...
                            <div>
                                ...
                                <x-text-input id="codigo" class="block mt-1 w-full" type="text" name="codigo" :value="old('codigo')" required placeholder="Ex: 3A-2026" />
                            ...
                            <div>
                                ...
                                <x-text-input id="ano" class="block mt-1 w-full" type="number" name="ano" :value="old('ano', date('Y'))" required min="2000" max="2100" />
                            ...
                            <div>
                                ...
                                <x-text-input id="vagas_total" class="block mt-1 w-full" type="number" name="vagas_total" :value="old('vagas_total', 30)" required min="1" />
                            ...
                            <div class="col-span-2">
                                ...
                                <textarea id="descricao" name="descricao" rows="3" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="Informações adicionais sobre a turma">{{ old('descricao') }}</textarea>

            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input id="valor" class="form-control @error('valor') is-invalid @enderror" type="text" name="valor" value="{{ old('valor', number_format($contaPagar->valor, 2, ',', '.')) }}" required data-mask="currency" placeholder="R$ 0,00">

...
@section('content_header')
    <h1><i class="fas fa-university"></i> Nova Conciliação Bancária</h1>
@stop

@section('content')
    <div class="card">
        <form method="POST" action="{{ route('financeiro.conciliacoes-bancarias.store') }}">
            @csrf
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input id="banco" class="form-control @error('banco') is-invalid @enderror" type="text" name="banco" value="{{ old('banco') }}" required>
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input id="saldo_inicial" class="form-control @error('saldo_inicial') is-invalid @enderror" type="number" step="0.01" name="saldo_inicial" value="{{ old('saldo_inicial') }}" required>
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input id="saldo_final" class="form-control @error('saldo_final') is-invalid @enderror" type="number" step="0.01" name="saldo_final" value="{{ old('saldo_final') }}" required>
